...
st.write(nama_negara = list(df_info[nama_negara])[i][0])
st.write(region_negara = df_info[region_negara])[i][0])
st.write(subregion_negara = df_info['sub-region_negara'])[i][0])
